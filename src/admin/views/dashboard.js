...
<a href="/admin/collections/${slug}" class="card bg-card border border-border hover:shadow-md transition-shadow cursor-pointer">
  <div class="card-body">
...
<div class="mb-6">
  ...
  <p class="text-muted-foreground text-sm mt-1">Welcome back, ${user?.name || user?.email || 'Admin'}</p>
</div>
<div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
  ${cards}
</div>
<div class="mt-8 card bg-card border border-border">
  <div class="card-body">
    <h2 class="card-header">Quick Links</h2>
    <div class="flex flex-wrap gap-3 mt-2">
      <a href="/admin/collections/posts/create" class="btn btn-primary btn-sm">New Post</a>
      <a href="/admin/collections/pages/create" class="btn btn-ghost btn-sm">New Page</a>
      <a href="/admin/globals/header" class="btn btn-ghost btn-sm">Edit Header</a>
      <a href="/admin/globals/footer" class="btn btn-ghost btn-sm">Edit Footer</a>
      <a href="/next/seed?secret=${process.env.PAYLOAD_SECRET || ''}" class="btn btn-ghost btn-sm">Seed DB</a>
    </div>
  </div>
</div>`
